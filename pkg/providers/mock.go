...
type MockClient struct {
	...
	ListInstancesFunc          func(ctx context.Context) (*egov3.ListInstancesResponse, error)
	DeleteInstanceFunc         func(ctx context.Context, id egov3.UUID) (*egov3.Resource, error)
	ListSecurityGroupsFunc     func(ctx context.Context) (*egov3.ListSecurityGroupsResponse, error)
...
func (m *MockClient) ListInstances(ctx context.Context) (*egov3.ListInstancesResponse, error) {
...
func (m *MockClient) DeleteInstance(ctx context.Context, id egov3.UUID) (*egov3.Resource, error) {
...
func (m *MockClient) ListSecurityGroups(ctx context.Context) (*egov3.ListSecurityGroupsResponse, error) {
	if m.ListSecurityGroupsFunc != nil {
		return m.ListSecurityGroupsFunc(ctx)
	}
	return nil, nil
}
